...
pipe = pickle.load(open("C:/Users/priyanshi/OneDrive/Desktop/laptop_price/pipe.pkl", 'rb'))
df = pickle.load(open("C:/Users/priyanshi/OneDrive/Desktop/laptop_price/df.pkl", 'rb'))
